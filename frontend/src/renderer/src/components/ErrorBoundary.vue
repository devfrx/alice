...
<template>
  ...
  <div v-else class="error-boundary" role="alert" aria-live="assertive">
    ...
    <div class="error-boundary__actions">
      <button class="error-boundary__btn" aria-label="Riprova" @click="retry">Riprova</button>
      <button
        class="error-boundary__btn error-boundary__btn--ghost"
        type="button"
        :aria-label="reportCopied ? 'Report copiato' : 'Copia report diagnostico'"
        @click="copyReport"
      >
