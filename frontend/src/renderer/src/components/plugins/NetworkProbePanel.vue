...
async function doPing(): Promise<void> {
  ...
  try {
    const res = await pluginsApi.executePluginTool<PingResult>('network_probe', 'ping_host', {
      host,
...
async function doScan(): Promise<void> {
  ...
  try {
    const res = await pluginsApi.executePluginTool<ScanResult>('network_probe', 'scan_ports', {
      host,
      ports
    })
...
async function doResolve(): Promise<void> {
  ...
  try {
    const res = await pluginsApi.executePluginTool<DnsResult>('network_probe', 'resolve_hostname', {
      query
    })
    ...
    <aside v-if="visible" class="net-probe">
      ...
      <nav class="net-probe__tabs" role="tablist" aria-label="Network probe tabs">
        <button
          ...
          class="net-probe__tab"
          :class="{ 'net-probe__tab--active': activeTab === t.key }"
      ...
      <div class="net-probe__body">
        ...
        <div v-if="activeTab === 'ping'" class="net-probe__section">
          ...
          <div class="net-probe__field">
            ...
            <input
              ...
              class="net-probe__input net-probe__input--sm"
              type="number"
              min="1"
              max="10"
            />
          ...
          <div v-if="pingResult" class="net-probe__card">
            ...
            <div v-if="pingResult.reachable" class="net-probe__row">
              ...
              <span
                >avg {{ fmtMs(pingResult.avg_ms) }} · min {{ fmtMs(pingResult.min_ms) }} · max
        ...
        <div v-if="activeTab === 'ports'" class="net-probe__section">
          ...
          <div class="net-probe__field-row">
            ...
            />
            <UiSelect
              :model-value="svcProtocol"
              :options="svcProtocolOptions"
              size="sm"
              aria-label="Protocollo"
              class="net-probe__select"
          ...
          <template v-if="traceResult">
            <div class="net-probe__card">
              ...
              <div class="net-probe__row">
                ...
                />
                <span
                  :class="traceResult.reached ? 'net-probe__text--ok' : 'net-probe__text--fail'"
                >
        ...
        <div v-if="activeTab === 'dns'" class="net-probe__section">
          ...
          <div v-if="dnsResult" class="net-probe__card">
            ...
            <div class="net-probe__row">
              ...
              <span>{{
                dnsResult.query_type === 'forward' ? 'Forward (A)' : 'Reverse (PTR)'
              }}</span>
            </div>
          ...
          <template v-if="connResult">
            ...
            <div v-for="(c, i) in connResult.connections" :key="i" class="net-probe__card">
              ...
              <div v-if="c.process_name" class="net-probe__row">
                ...
                <span
                  >{{ c.process_name
                  }}<span v-if="c.pid" class="net-probe__port-svc"> (PID {{ c.pid }})</span></span
                >
              </div>
            </div>
          </template>
