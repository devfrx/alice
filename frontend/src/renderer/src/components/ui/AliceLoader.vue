    ...
    <div v-if="visible" class="alice-splash" role="status" :aria-label="message">
      ...
      <div class="alice-splash__logo" aria-hidden="true">
        ...
        >
          ...
          <circle
            class="alice-splash__ring alice-splash__ring--outer"
            cx="60"
            cy="60"
            r="52"
            stroke="var(--accent)"
            stroke-width="1.2"
            stroke-dasharray="272 54"
            stroke-dashoffset="0"
          ...
          <circle
            class="alice-splash__ring alice-splash__ring--mid"
            cx="60"
            cy="60"
            r="37"
            stroke="var(--accent)"
          ...
          <circle
            class="alice-splash__ring alice-splash__ring--inner"
            cx="60"
            cy="60"
            r="22"
            stroke="var(--accent)"
