...
<template>
  <UiCard variant="subtle" no-padding class="artifact-card">
    <div class="artifact-card__preview">
      ...
      <button
        class="artifact-card__pin"
        :class="{ 'artifact-card__pin--active': artifact.pinned }"
    ...
    <div class="artifact-card__body">
      ...
      <button
        class="artifact-card__conv"
        :title="`Apri «${conversationLabel}»`"
    ...
    <div class="artifact-card__actions">
      <a
        class="artifact-card__action artifact-card__action--link"
        :href="downloadHref"
        :download="artifact.title || 'artifact'"
        :title="`Scarica ${artifact.title}`"
      ...
      <UiIconButton
        variant="ghost"
        size="sm"
        label="Apri nella conversazione"
        @click="openConversation"
      >
