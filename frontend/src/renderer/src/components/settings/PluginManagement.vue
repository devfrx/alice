<template>
  <section class="settings-section">
    ...
    <p class="plugins-hint">
      I plugin aggiungono strumenti (tool) che l'assistente può utilizzare durante le conversazioni.
    ...
    <div v-else class="plugins-list">
      ...
      >
        <div class="plugin-info">
          ...
          <div
            v-if="plugin.enabled && plugin.tools && plugin.tools.length > 0"
            class="plugin-tools"
          >
            <span
              v-for="tool in plugin.tools"
              :key="tool.name"
              class="plugin-tool-tag"
